...
class HighestWinRateServiceRecord extends BasePlayerStat implements AnalyticInterface
{
    ...
    {
        return 'Highest Win Rate (1k game min)';
    }

    public function key(): string
    {
        return AnalyticKey::HIGHEST_WIN_RATE_SR->value;
    }
